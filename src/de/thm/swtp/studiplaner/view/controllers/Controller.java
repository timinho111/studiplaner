...
public class Controller implements Initializable{
    ...
    private void ButtonAction(ActionEvent e) throws IOException
    {
        ...
        Parent root=FXMLLoader.load(getClass().getResource("view/fxml/Dashboard.fxml"));

        if(e.getSource()==login_button)
        {
            stage=(Stage) login_button.getScene().getWindow();
            root= FXMLLoader.load(getClass().getResource("view/fxml/Dashboard.fxml"));
        }
        ...
        if(e.getSource()==kalender_button)
        {
            ...
            root= FXMLLoader.load(getClass().getResource("view/fxml/Kalender.fxml"));
        }
        if(e.getSource()==module_button)
        {
            stage=(Stage) module_button.getScene().getWindow();
            root= FXMLLoader.load(getClass().getResource("view/fxml/Module.fxml"));
        }
        if(e.getSource()==todo_button)
        {
            stage=(Stage) todo_button.getScene().getWindow();
            root= FXMLLoader.load(getClass().getResource("view/fxml/ToDo.fxml"));
        }
        if(e.getSource()==stundenplan_button)
        {
            stage=(Stage) stundenplan_button.getScene().getWindow();
            root= FXMLLoader.load(getClass().getResource("view/fxml/Stundenplan.fxml"));
        }
        if(e.getSource()==klausurplan_button)
        {
            stage=(Stage) klausurplan_button.getScene().getWindow();
            root= FXMLLoader.load(getClass().getResource("view/fxml/Klausurplan.fxml"));
        }

        if(e.getSource()==mensaplan_button)
        {
            stage=(Stage) mensaplan_button.getScene().getWindow();
            root=FXMLLoader.load(getClass().getResource("view/fxml/Mensaplan.fxml"));
        }

        if(e.getSource()==noten_button)
        {
            stage=(Stage) noten_button.getScene().getWindow();
            root= FXMLLoader.load(getClass().getResource("view/fxml/Noten.fxml"));
        }
